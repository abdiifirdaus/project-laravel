  ...
  <head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/logolj.png" />
  ...
  <body id="page-top">
    ...
    <!-- education Section-->
    <section class="page-section portfolio" id="education">
      <div class="container">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @if ($whatsapp)
            <a class="btn btn-outline-light btn-social mx-1" href="{{ $whatsapp }}" target="blank"><i class="fab fa-fw fa-whatsapp"></i></a>    
            @endif
           
          </div>
          <!-- Footer About Text-->
          <div class="col-lg-4">
            <h4 class="text-uppercase mb-4">About Description</h4>
            <p class="lead mb-0">
              {{ $site_description }}
            </p>
          </div>
